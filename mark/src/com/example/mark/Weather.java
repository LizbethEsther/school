    ...
    public void onWeatherLiveSearched(LocalWeatherLiveResult weatherLiveResult, int rCode) {
        if (rCode == 1000) {
            if (weatherLiveResult != null && weatherLiveResult.getLiveResult() != null) {
            	...
            	Toast.makeText(Weather.this, "失败1", Toast.LENGTH_SHORT).show();
            }
        } else {
        	Toast.makeText(Weather.this, "失败2", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onWeatherForecastSearched(
        ...
        if (rCode == 1000) {
            if (weatherForecastResult != null && weatherForecastResult.getForecastResult() != null
            	...
            	Toast.makeText(Weather.this, "失败3", Toast.LENGTH_SHORT).show();
            }
        } else {
        	Toast.makeText(Weather.this, "失败4", Toast.LENGTH_SHORT).show();
        }
    }
